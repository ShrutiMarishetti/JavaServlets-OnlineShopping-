			...
			<div class="row mt-5">
				<div class="col-md-4 offset-md-4">
						<div class="card">
							...
							<div align="center"><%-- <%@ include file="components/response.jsp" %> --%></div>
							...
							<div class="card-body px-5">
								...
								<%
								           if(null!= request.getAttribute("RegistrationSuccessful"))
								        	     //request.getAttribute("RegistrationSuccessful");
								                 {
								                	 String successMsg=(String)request.getAttribute("RegistrationSuccessful");%>
								                     <p> <%=successMsg %></p> 
								<% 
								}
								%>
								<!--  doing this for customising the page after reg -->
						
								<form action="Register" method="POST" >
										
									<div class="form-group">
									    <label for="name">User Name</label>
									    <input type="text" class="form-control" id="name" name="userName" aria-describedby="nameHelp" placeholder="Enter Username">
									...
									<div class="form-group">
									    ...
									    <input type="email" class="form-control" id="emailId" name="emailId" aria-describedby="emailHelp" placeholder="Enter EmailId">
